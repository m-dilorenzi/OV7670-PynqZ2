...
reg   [0:0] icmp_ln126_reg_280;
reg    outStream_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln126_reg_280_pp0_iter1_reg;
reg   [31:0] t_V_4_reg_175;
wire  signed [31:0] rows_V_fu_186_p1;
reg  signed [31:0] rows_V_reg_256;
reg    ap_block_state1;
wire  signed [31:0] cols_V_fu_190_p1;
reg  signed [31:0] cols_V_reg_261;
wire   [32:0] ret_V_fu_198_p2;
reg   [32:0] ret_V_reg_266;
wire   [0:0] icmp_ln125_fu_209_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [31:0] i_V_fu_214_p2;
reg   [31:0] i_V_reg_275;
...
wire   [31:0] j_V_fu_225_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_235_p2;
reg   [0:0] axi_last_V_reg_289;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [31:0] t_V_reg_164;
wire    ap_CS_fsm_state6;
reg   [0:0] tmp_user_V_fu_112;
reg    ap_block_pp0_stage0_01001;
wire   [32:0] zext_ln1354_fu_194_p1;
wire   [32:0] zext_ln879_fu_231_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_data_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)))) begin
            AXI_video_strm_V_data_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_data_V_1_vld_in) & (1'b1 == AXI_video_strm_V_data_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_data_V_1_state)) | ((2'd1 == AXI_video_strm_V_data_V_1_state) & (1'b1 == AXI_video_strm_V_data_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_data_V_1_state) & (1'b1 == AXI_video_strm_V_data_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_dest_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)))) begin
            AXI_video_strm_V_dest_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_dest_V_1_vld_in) & (1'b1 == AXI_video_strm_V_dest_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_dest_V_1_state)) | ((2'd1 == AXI_video_strm_V_dest_V_1_state) & (1'b1 == AXI_video_strm_V_dest_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_dest_V_1_state) & (1'b1 == AXI_video_strm_V_dest_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_id_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)))) begin
            AXI_video_strm_V_id_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_id_V_1_vld_in) & (1'b1 == AXI_video_strm_V_id_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_id_V_1_state)) | ((2'd1 == AXI_video_strm_V_id_V_1_state) & (1'b1 == AXI_video_strm_V_id_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_id_V_1_state) & (1'b1 == AXI_video_strm_V_id_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_keep_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)))) begin
            AXI_video_strm_V_keep_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_keep_V_1_vld_in) & (1'b1 == AXI_video_strm_V_keep_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_keep_V_1_state)) | ((2'd1 == AXI_video_strm_V_keep_V_1_state) & (1'b1 == AXI_video_strm_V_keep_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_keep_V_1_state) & (1'b1 == AXI_video_strm_V_keep_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_last_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)))) begin
            AXI_video_strm_V_last_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_last_V_1_vld_in) & (1'b1 == AXI_video_strm_V_last_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_last_V_1_state)) | ((2'd1 == AXI_video_strm_V_last_V_1_state) & (1'b1 == AXI_video_strm_V_last_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_last_V_1_state) & (1'b1 == AXI_video_strm_V_last_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_strb_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)))) begin
            AXI_video_strm_V_strb_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_strb_V_1_vld_in) & (1'b1 == AXI_video_strm_V_strb_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_strb_V_1_state)) | ((2'd1 == AXI_video_strm_V_strb_V_1_state) & (1'b1 == AXI_video_strm_V_strb_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_strb_V_1_state) & (1'b1 == AXI_video_strm_V_strb_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((2'd1 == AXI_video_strm_V_user_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)))) begin
            AXI_video_strm_V_user_V_1_state <= 2'd1;
        end else if (((~((1'b0 == AXI_video_strm_V_user_V_1_vld_in) & (1'b1 == AXI_video_strm_V_user_V_1_ack_out)) & ~((outStream_TREADY == 1'b0) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)) & (2'd3 == AXI_video_strm_V_user_V_1_state)) | ((2'd1 == AXI_video_strm_V_user_V_1_state) & (1'b1 == AXI_video_strm_V_user_V_1_ack_out)) | ((2'd2 == AXI_video_strm_V_user_V_1_state) & (1'b1 == AXI_video_strm_V_user_V_1_vld_in)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (outStream_TREADY == 1'b0))) & (icmp_ln125_fu_209_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (outStream_TREADY == 1'b0))) & (icmp_ln125_fu_209_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_fu_220_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_reg_280 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_user_V_fu_112 <= 1'd0;
    end else if ((~((ap_start == 1'b0) | (img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_112 <= 1'd1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_fu_220_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln126_fu_220_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln126_reg_280 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((icmp_ln126_reg_280_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln126_reg_280 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        outStream_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln126_fu_220_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln126_fu_220_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign AXI_video_strm_V_data_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = outStream_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = outStream_TREADY;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln126_reg_280 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_280 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_280 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2 = ((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (outStream_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (outStream_TREADY == 1'b0)));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((icmp_ln126_reg_280 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln126_reg_280 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln126_reg_280_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_235_p2 = ((zext_ln879_fu_231_p1 == ret_V_reg_266) ? 1'b1 : 1'b0);

assign cols_V_fu_190_p1 = $signed(img_cols_V_dout);

assign i_V_fu_214_p2 = (t_V_reg_164 + 32'd1);

assign icmp_ln125_fu_209_p2 = ((t_V_reg_164 == rows_V_reg_256) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_220_p2 = ((t_V_4_reg_175 == cols_V_reg_261) ? 1'b1 : 1'b0);

assign j_V_fu_225_p2 = (t_V_4_reg_175 + 32'd1);

assign outStream_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign outStream_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign outStream_TID = AXI_video_strm_V_id_V_1_data_out;

assign outStream_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign outStream_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign outStream_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign outStream_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign outStream_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];

assign ret_V_fu_198_p2 = ($signed(zext_ln1354_fu_194_p1) + $signed(33'd8589934591));

assign rows_V_fu_186_p1 = $signed(img_rows_V_dout);

assign zext_ln1354_fu_194_p1 = $unsigned(cols_V_fu_190_p1);

assign zext_ln879_fu_231_p1 = t_V_4_reg_175;
