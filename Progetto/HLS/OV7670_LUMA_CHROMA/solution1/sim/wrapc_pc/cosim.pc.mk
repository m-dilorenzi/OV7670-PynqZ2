...
$(ObjDir)/ov7670_LUMA_CHROMA.cpp_pre.cpp.tb.o : ov7670_LUMA_CHROMA.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ov7670_LUMA_CHROMA.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
