...
// ==============================================================
#ifndef __scaleImage_sdiv_4dEe__HH__
#define __scaleImage_sdiv_4dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(scaleImage_sdiv_4dEe) {
    ...
    SC_CTOR(scaleImage_sdiv_4dEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
