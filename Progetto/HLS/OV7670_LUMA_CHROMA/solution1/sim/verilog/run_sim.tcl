...
if {[file isfile ov7670_LUMA_CHROMA.autotvin.dat]} {
	file delete -force ov7670_LUMA_CHROMA.autotvin.dat
}

if {[file isfile ov7670_LUMA_CHROMA.autotvout.dat]} {
	file delete -force ov7670_LUMA_CHROMA.autotvout.dat
}
