...
struct Resize : public sc_module {
    ...
    sc_signal< sc_lv<11> > p_dst_rows_V_read_reg_176;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<11> > p_dst_cols_V_read_reg_181;
    sc_signal< sc_lv<10> > p_src_rows_V_read_reg_186;
    sc_signal< sc_lv<11> > p_src_cols_V_read_reg_191;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_ap_start;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_ap_done;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_ap_idle;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_ap_ready;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_p_src_data_stream_V_read;
    sc_signal< sc_lv<8> > grp_Resize_opr_linear_fu_160_p_dst_data_stream_V_din;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_p_dst_data_stream_V_write;
    sc_signal< sc_logic > grp_Resize_opr_linear_fu_160_ap_start_reg;
    ...
    void thread_grp_Resize_opr_linear_fu_160_ap_start();
