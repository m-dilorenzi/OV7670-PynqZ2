...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ov7670_LUMA_CHROMA.autotvin_inStream_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvin_outStream_grayscale_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvin_enable_raw_stream.dat"
         "c.ov7670_LUMA_CHROMA.autotvin_outStream_LUMA_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvin_outStream_CHROMA_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvout_outStream_grayscale_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvout_outStream_LUMA_V_V.dat"
         "c.ov7670_LUMA_CHROMA.autotvout_outStream_CHROMA_V_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ov7670_LUMA_CHROMA.autotvout_outStream_grayscale_V_V.dat"
         "rtl.ov7670_LUMA_CHROMA.autotvout_outStream_LUMA_V_V.dat"
         "rtl.ov7670_LUMA_CHROMA.autotvout_outStream_CHROMA_V_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
