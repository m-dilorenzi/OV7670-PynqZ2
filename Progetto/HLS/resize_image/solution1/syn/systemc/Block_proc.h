...
struct Block_proc : public sc_module {
    ...
    sc_out< sc_lv<10> > inImage_rows_V_out_din;
    ...
    sc_out< sc_lv<11> > outImage_rows_V_out_din;
    sc_in< sc_logic > outImage_rows_V_out_full_n;
    sc_out< sc_logic > outImage_rows_V_out_write;
    sc_out< sc_lv<11> > outImage_cols_V_out_din;
    sc_in< sc_logic > outImage_cols_V_out_full_n;
    sc_out< sc_logic > outImage_cols_V_out_write;
    ...
    sc_signal< sc_logic > outImage_rows_V_out_blk_n;
    sc_signal< sc_logic > outImage_cols_V_out_blk_n;
    ...
    void thread_outImage_cols_V_out_blk_n();
    void thread_outImage_cols_V_out_din();
    void thread_outImage_cols_V_out_write();
    void thread_outImage_rows_V_out_blk_n();
    void thread_outImage_rows_V_out_din();
    void thread_outImage_rows_V_out_write();
