...
-- Command     : write_vhdl -force -mode synth_stub -rename_top design_1_gray2rgb_0_0 -prefix
--               design_1_gray2rgb_0_0_ design_1_gray2rgb_0_0_stub.vhdl
...
architecture stub of design_1_gray2rgb_0_0 is
attribute syn_black_box : boolean;
attribute black_box_pad_pin : string;
attribute syn_black_box of stub : architecture is true;
attribute black_box_pad_pin of stub : architecture is "inStream_TVALID,inStream_TREADY,inStream_TDATA[7:0],inStream_TKEEP[0:0],inStream_TSTRB[0:0],inStream_TUSER[0:0],inStream_TLAST[0:0],inStream_TID[0:0],inStream_TDEST[0:0],outStream_TVALID,outStream_TREADY,outStream_TDATA[23:0],outStream_TKEEP[2:0],outStream_TSTRB[2:0],outStream_TUSER[0:0],outStream_TLAST[0:0],outStream_TID[0:0],outStream_TDEST[0:0],ap_clk,ap_rst_n,ap_start,ap_done,ap_ready,ap_idle";
attribute X_CORE_INFO : string;
attribute X_CORE_INFO of stub : architecture is "gray2rgb,Vivado 2019.1";
begin
end;
