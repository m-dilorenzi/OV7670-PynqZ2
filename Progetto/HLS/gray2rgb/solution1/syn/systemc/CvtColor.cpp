...
void CvtColor::thread_i_fu_207_p2() {
    i_fu_207_p2 = (!i_0_i_reg_176.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_0_i_reg_176.read()) + sc_biguint<10>(ap_const_lv10_1));
}

void CvtColor::thread_icmp_ln1967_fu_202_p2() {
    icmp_ln1967_fu_202_p2 = (!zext_ln1967_fu_198_p1.read().is_01() || !p_src_rows_V_read_reg_233.read().is_01())? sc_lv<1>(): (sc_bigint<11>(zext_ln1967_fu_198_p1.read()) < sc_bigint<11>(p_src_rows_V_read_reg_233.read()));
}

void CvtColor::thread_icmp_ln1968_fu_217_p2() {
    icmp_ln1968_fu_217_p2 = (!zext_ln1968_fu_213_p1.read().is_01() || !p_src_cols_V_read_reg_228.read().is_01())? sc_lv<1>(): (sc_bigint<11>(zext_ln1968_fu_213_p1.read()) < sc_bigint<11>(p_src_cols_V_read_reg_228.read()));
}
...
void CvtColor::thread_j_fu_222_p2() {
    j_fu_222_p2 = (!j_0_i_reg_187.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(j_0_i_reg_187.read()) + sc_biguint<10>(ap_const_lv10_1));
}
...
void CvtColor::thread_zext_ln1967_fu_198_p1() {
    zext_ln1967_fu_198_p1 = esl_zext<11,10>(i_0_i_reg_176.read());
}

void CvtColor::thread_zext_ln1968_fu_213_p1() {
    zext_ln1968_fu_213_p1 = esl_zext<11,10>(j_0_i_reg_187.read());
}
