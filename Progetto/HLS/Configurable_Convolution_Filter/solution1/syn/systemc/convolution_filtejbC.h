...
// ==============================================================
#ifndef __convolution_filtejbC__HH__
#define __convolution_filtejbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(convolution_filtejbC) {
    ...
    SC_CTOR(convolution_filtejbC):  simcore_mac_1_U ("simcore_mac_1_U") {
