...
set ArgLastReadFirstWriteLatency {
	ov7670_LUMA_CHROMA {
		...
		outStream_grayscale_V_V {Type O LastRead -1 FirstWrite 0}
		enable_raw_stream {Type I LastRead 0 FirstWrite -1}
		outStream_LUMA_V_V {Type O LastRead -1 FirstWrite 1}
		outStream_CHROMA_V_V {Type O LastRead -1 FirstWrite 0}
