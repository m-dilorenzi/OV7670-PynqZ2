...
architecture behav of Mat2AXIvideo is 
    ...
    signal t_V_1_reg_184 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    axi_last_V_fu_224_p2 <= "1" when (t_V_1_reg_184 = ap_const_lv10_31F) else "0";
    i_V_fu_206_p2 <= std_logic_vector(unsigned(t_V_reg_173) + unsigned(ap_const_lv10_1));
    icmp_ln125_fu_200_p2 <= "1" when (t_V_reg_173 = ap_const_lv10_258) else "0";
    icmp_ln126_fu_212_p2 <= "1" when (t_V_1_reg_184 = ap_const_lv10_320) else "0";
    ...
    j_V_fu_218_p2 <= std_logic_vector(unsigned(t_V_1_reg_184) + unsigned(ap_const_lv10_1));
    outStream_TDATA <= AXI_video_strm_V_data_V_1_data_out;

    outStream_TDATA_blk_n_assign_proc : process(AXI_video_strm_V_data_V_1_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln126_reg_266, ap_enable_reg_pp0_iter2, icmp_ln126_reg_266_pp0_iter1_reg)
    begin
