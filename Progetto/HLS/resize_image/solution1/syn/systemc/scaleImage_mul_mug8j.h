...
// ==============================================================
#ifndef __scaleImage_mul_mug8j__HH__
#define __scaleImage_mul_mug8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(scaleImage_mul_mug8j) {
    ...
    SC_CTOR(scaleImage_mul_mug8j):  ACMP_smul_us_U ("ACMP_smul_us_U") {
