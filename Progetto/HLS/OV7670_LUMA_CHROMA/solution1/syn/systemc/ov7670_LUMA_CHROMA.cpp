...
const sc_lv<4> ov7670_LUMA_CHROMA::ap_ST_fsm_state1 = "1";
const sc_lv<4> ov7670_LUMA_CHROMA::ap_ST_fsm_state2 = "10";
const sc_lv<4> ov7670_LUMA_CHROMA::ap_ST_fsm_state3 = "100";
const sc_lv<4> ov7670_LUMA_CHROMA::ap_ST_fsm_state4 = "1000";
...
ov7670_LUMA_CHROMA::ov7670_LUMA_CHROMA(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_predicate_op22_write_state1 );

    SC_METHOD(thread_ap_block_state2_io);
    sensitive << ( outStream_CHROMA_V_V_1_ack_in );
    sensitive << ( enable_raw_stream_re_read_fu_42_p2 );
    ...
    sensitive << ( outStream_LUMA_V_V_1_ack_in );
    sensitive << ( ap_predicate_op30_write_state4 );
    ...
    SC_METHOD(thread_ap_predicate_op22_write_state1);
    sensitive << ( grayscale_valid );
    sensitive << ( enable_raw_stream_re_read_fu_42_p2 );

    SC_METHOD(thread_ap_predicate_op30_write_state4);
    sensitive << ( enable_raw_stream_re_read_fu_42_p2 );
    ...
    SC_METHOD(thread_enable_raw_stream_re_read_fu_42_p2);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( inStream_V_V_0_vld_out );
    ...
    SC_METHOD(thread_xor_ln30_fu_81_p2);
    sensitive << ( grayscale_valid_load_reg_103 );
    ...
    sc_trace(mVcdFile, enable_raw_stream_re_read_fu_42_p2, "enable_raw_stream_re_read_fu_42_p2");
    ...
    sc_trace(mVcdFile, ap_predicate_op22_write_state1, "ap_predicate_op22_write_state1");
    sc_trace(mVcdFile, ap_block_state1_io, "ap_block_state1_io");
    sc_trace(mVcdFile, tmp_V_reg_96, "tmp_V_reg_96");
    sc_trace(mVcdFile, xor_ln30_fu_81_p2, "xor_ln30_fu_81_p2");
    sc_trace(mVcdFile, ap_block_state4, "ap_block_state4");
    sc_trace(mVcdFile, ap_predicate_op30_write_state4, "ap_predicate_op30_write_state4");
...
void ov7670_LUMA_CHROMA::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
             !(esl_seteq<1,2,2>(ap_const_lv2_1, outStream_grayscale_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_LUMA_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_CHROMA_V_V_1_state.read()) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_grayscale_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_LUMA_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_CHROMA_V_V_1_state.read())) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state4_io.read())))) {
            grayscale_valid = xor_ln30_fu_81_p2.read();
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_1_vld_in.read()) && 
            ...
            outStream_CHROMA_V_V_1_state = ap_const_lv2_2;
                     ...
                     esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_3, outStream_CHROMA_V_V_1_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read()) && 
            ...
            outStream_CHROMA_V_V_1_state = ap_const_lv2_1;
                    ...
                    (esl_seteq<1,1,1>(ap_const_logic_1, outStream_CHROMA_V_V_1_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, outStream_CHROMA_V_V_1_state.read())) || 
                    (esl_seteq<1,2,2>(ap_const_lv2_3, outStream_CHROMA_V_V_1_state.read()) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_1, outStream_CHROMA_V_V_1_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read())) && 
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_1_vld_in.read()) && 
            ...
            outStream_LUMA_V_V_1_state = ap_const_lv2_2;
                     ...
                     esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_3, outStream_LUMA_V_V_1_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read()) && 
            ...
            outStream_LUMA_V_V_1_state = ap_const_lv2_1;
                    ...
                    (esl_seteq<1,1,1>(ap_const_logic_1, outStream_LUMA_V_V_1_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, outStream_LUMA_V_V_1_state.read())) || 
                    (esl_seteq<1,2,2>(ap_const_lv2_3, outStream_LUMA_V_V_1_state.read()) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_1, outStream_LUMA_V_V_1_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read())) && 
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if (((esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_1_vld_in.read()) && 
            ...
            outStream_grayscale_V_V_1_state = ap_const_lv2_2;
                     ...
                     esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_3, outStream_grayscale_V_V_1_state.read())) || 
                    (esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read()) && 
            ...
            outStream_grayscale_V_V_1_state = ap_const_lv2_1;
                    ...
                    (esl_seteq<1,1,1>(ap_const_logic_1, outStream_grayscale_V_V_1_ack_out.read()) && 
                     esl_seteq<1,2,2>(ap_const_lv2_1, outStream_grayscale_V_V_1_state.read())) || 
                    (esl_seteq<1,2,2>(ap_const_lv2_3, outStream_grayscale_V_V_1_state.read()) && 
                     !(esl_seteq<1,1,1>(ap_const_logic_1, outStream_grayscale_V_V_1_vld_in.read()) && esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read())) && 
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
...
void ov7670_LUMA_CHROMA::thread_ap_block_state1() {
    ap_block_state1 = (esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()));
}

void ov7670_LUMA_CHROMA::thread_ap_block_state1_io() {
    ap_block_state1_io = ((esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_1_ack_in.read()) && 
  esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op22_write_state1.read())) || (esl_seteq<1,1,1>(ap_const_lv1_1, grayscale_valid.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_1_ack_in.read())));
}

void ov7670_LUMA_CHROMA::thread_ap_block_state2_io() {
    ap_block_state2_io = (esl_seteq<1,1,1>(ap_const_lv1_1, enable_raw_stream_re_read_fu_42_p2.read()) && esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_1_ack_in.read()));
}

void ov7670_LUMA_CHROMA::thread_ap_block_state3_io() {
    ap_block_state3_io = (esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_1_ack_in.read()) || (esl_seteq<1,1,1>(ap_const_lv1_1, enable_raw_stream_re_read_fu_42_p2.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_1_ack_in.read())));
}

void ov7670_LUMA_CHROMA::thread_ap_block_state4() {
    ap_block_state4 = (esl_seteq<1,2,2>(ap_const_lv2_1, outStream_grayscale_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_LUMA_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_CHROMA_V_V_1_state.read()) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_grayscale_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_LUMA_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_CHROMA_V_V_1_state.read())));
}
...
void ov7670_LUMA_CHROMA::thread_ap_block_state4_io() {
    ap_block_state4_io = (esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_1_ack_in.read()) && esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op30_write_state4.read()));
}
...
void ov7670_LUMA_CHROMA::thread_ap_predicate_op22_write_state1() {
    ap_predicate_op22_write_state1 = (esl_seteq<1,1,1>(ap_const_lv1_1, enable_raw_stream_re_read_fu_42_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, grayscale_valid.read()));
}

void ov7670_LUMA_CHROMA::thread_ap_predicate_op30_write_state4() {
    ap_predicate_op30_write_state4 = (esl_seteq<1,1,1>(ap_const_lv1_1, enable_raw_stream_re_read_fu_42_p2.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, grayscale_valid_load_reg_103.read()));
}
...
void ov7670_LUMA_CHROMA::thread_enable_raw_stream_re_read_fu_42_p2() {
    enable_raw_stream_re_read_fu_42_p2 =  (sc_lv<1>) (enable_raw_stream.read());
}
...
void ov7670_LUMA_CHROMA::thread_inStream_V_V_0_ack_out() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
...
void ov7670_LUMA_CHROMA::thread_outStream_CHROMA_V_V_1_vld_in() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         esl_seteq<1,1,1>(ap_const_boolean_1, ap_predicate_op22_write_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
...
void ov7670_LUMA_CHROMA::thread_outStream_CHROMA_V_V_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
          esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
          esl_seteq<1,1,1>(ap_const_lv1_1, enable_raw_stream_re_read_fu_42_p2.read()) && 
...
void ov7670_LUMA_CHROMA::thread_xor_ln30_fu_81_p2() {
    xor_ln30_fu_81_p2 = (grayscale_valid_load_reg_103.read() ^ ap_const_lv1_1);
}

void ov7670_LUMA_CHROMA::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, grayscale_valid.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
                ap_NS_fsm = ap_ST_fsm_state2;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_const_lv1_1, grayscale_valid.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, ap_start.read()) || esl_seteq<1,1,1>(ap_const_logic_0, inStream_V_V_0_vld_out.read()) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state1_io.read())))) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && !(esl_seteq<1,2,2>(ap_const_lv2_1, outStream_grayscale_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_LUMA_V_V_1_state.read()) || esl_seteq<1,2,2>(ap_const_lv2_1, outStream_CHROMA_V_V_1_state.read()) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_grayscale_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_grayscale_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_LUMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_LUMA_V_V_1_state.read())) || (esl_seteq<1,1,1>(ap_const_logic_0, outStream_CHROMA_V_V_TREADY.read()) && 
  esl_seteq<1,2,2>(ap_const_lv2_3, outStream_CHROMA_V_V_1_state.read())) || esl_seteq<1,1,1>(ap_const_boolean_1, ap_block_state4_io.read())))) {
                ap_NS_fsm = ap_ST_fsm_state1;
