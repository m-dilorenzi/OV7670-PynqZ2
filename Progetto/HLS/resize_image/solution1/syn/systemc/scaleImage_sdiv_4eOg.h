...
// ==============================================================
#ifndef __scaleImage_sdiv_4eOg__HH__
#define __scaleImage_sdiv_4eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(scaleImage_sdiv_4eOg) {
    ...
    SC_CTOR(scaleImage_sdiv_4eOg):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
