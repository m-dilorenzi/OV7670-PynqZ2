...
struct LF_valid_to_AXIS : public sc_module {
    ...
    sc_signal< sc_lv<1> > res_load_reg_74;
    sc_signal< sc_lv<1> > frame_valid_read_reg_78;
    sc_signal< sc_lv<1> > line_valid_read_reg_82;
    sc_signal< bool > ap_predicate_op19_write_state1;
    ...
    void thread_ap_done();
    void thread_ap_idle();
    void thread_ap_predicate_op19_write_state1();
