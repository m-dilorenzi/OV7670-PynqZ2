...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ov7670_LUMA_CHROMA.autotvin.dat"
	set constFileTvOut       "ov7670_LUMA_CHROMA.autotvout.dat"
	set constFileHdlTvIn     "ov7670_LUMA_CHROMA.autohdltvin.dat"
	set constFileHdlTvOut    "ov7670_LUMA_CHROMA.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
